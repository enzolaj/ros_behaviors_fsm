...
def distance_ahead(ranges):
    return 5.0
 
class CollisionAvoidanceBehavior: 
    def __init__(self, stop_distance=0.5, forward_speed=0.2):
        self.stop_distance = stop_distance      # meters
        self.forward_speed = forward_speed      # m/s
...
class CollisionAvoidanceNode(Node):
    def __init__(self):
        ...
        self.behavior = CollisionAvoidanceBehavior()
    ...
    def run_loop(self):
        cmd = self.behavior.compute_command(self.latest_ranges, self.bump_hit)
